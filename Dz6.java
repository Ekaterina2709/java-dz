...
public class Dz6 {
   public static void main(String[] args) {
      ...
      Notebook notebook4 = new Notebook("Acer", "16", "1000", "Windows", "grey");
      Notebook notebook5 = new Notebook("Huawei", "8", "1000", "Windows", "red");
   ...
   public static Map<String, String> selectCriteria() {
      ...
      while (true) {
         System.out.println("Вы хотите выбрать Ноутбук по критериям? Если да введите 'y', если нет введите 'n'");
